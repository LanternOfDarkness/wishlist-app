            ...
            localItems.map((item) => (
              ...
              >
                <input
                  ...
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed peer"
                />
                <Label
                  htmlFor={`widget-${item.id}`}
                  className="flex-1 cursor-pointer peer-disabled:cursor-not-allowed truncate"
                >
                  {item.name}{" "}
